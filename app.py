...
app.config['MAIL_USERNAME'] = 'paseotravelinc@gmail.com'  # Cambiar por tu correo
app.config['MAIL_PASSWORD'] = 'eabjkyeaansifqyp '  # Cambiar por tu contraseña de aplicación
